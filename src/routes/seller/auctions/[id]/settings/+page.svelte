            ...
            <div class="border border-gray-200 rounded-lg">
              ...
              {#if expandedSections.liveAuction}
                <div class="p-4 space-y-4">
                  ...
                  <label class="flex items-start">
                    <input type="checkbox" bind:checked={settings.buyerPaysShipping} class="mt-0.5 mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
                    <div>
                      <span class="text-sm font-medium text-gray-700">Buyer pays shipping</span>
                      <p class="text-xs text-gray-500">When paying their invoice, the buyer chooses a shipping rate. The label is created for you after payment.</p>
                    </div>
                  </label>
                  <div>
